...
// Color sweeps cool → hot as you scroll: mint → cyan → blue → indigo → purple.
// Matches the extension FORMS + the evolution grid so the brand reads as one thing.
const STAGES: Stage[] = [
  {
    min: 0,
    lv: 1,
  ...
  },
  {
    ...
    speech: "another post?",
    accent: "#3fe0c8",
    soft: "rgba(63,224,200,0.12)",
    glow: "rgba(63,224,200,0.5)",
    skin: { body: "#14564a", horn: "#0c3a32", eye: "#5ff0d8" },
  },
  {
    min: 0.4,
    lv: 3,
    ...
    accent: "#38c0ff",
    soft: "rgba(56,192,255,0.12)",
    glow: "rgba(56,192,255,0.5)",
    skin: { body: "#134a66", horn: "#0c3247", eye: "#7ad0ff" },
  },
  {
    min: 0.6,
    lv: 4,
    ...
    speech: "+50 XP!",
    accent: "#6a8cff",
    soft: "rgba(106,140,255,0.12)",
    glow: "rgba(106,140,255,0.5)",
    skin: { body: "#2a3a7a", horn: "#1a2550", eye: "#9db0ff" },
  },
  {
    min: 0.8,
    lv: 5,
    ...
    speech: "cook again.",
    accent: "#a96cff",
    soft: "rgba(169,108,255,0.12)",
    glow: "rgba(169,108,255,0.5)",
    skin: { body: "#4a2a80", horn: "#301a55", eye: "#c8a8ff" },
  },
];
