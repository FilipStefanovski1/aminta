...
export const LEVELS: DemonLevel[] = [
  ...
  { lv: 2, name: "Curious",     xp: 300,   skin: { body: "#14564a", horn: "#0c3a32", eye: "#5ff0d8" } },
  { lv: 3, name: "Happy",       xp: 750,   skin: { body: "#134a66", horn: "#0c3247", eye: "#7ad0ff" } },
  { lv: 4, name: "Excited",     xp: 1400,  skin: { body: "#3a52c8", horn: "#222e88", eye: "#c8d8ff" } },
  { lv: 5, name: "Mischievous", xp: 2300,  skin: { body: "#4a2a80", horn: "#301a55", eye: "#c8a8ff" } },
  { lv: 6, name: "Confident",   xp: 3500,  skin: { body: "#66248a", horn: "#45185f", eye: "#e8a8ff" } },
  { lv: 7, name: "Guardian",    xp: 5200,  skin: { body: "#8a2470", horn: "#5f1850", eye: "#ffa8e0" } },
  { lv: 8, name: "Mythic",      xp: 7500,  skin: { body: "#8a2440", horn: "#5f1830", eye: "#ffa8b8" } },
  { lv: 9, name: "Ascended",    xp: 10500, skin: { body: "#8a2424", horn: "#5f1818", eye: "#ffa8a8" } },
];
