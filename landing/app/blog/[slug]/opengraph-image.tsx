...
import { getEditionBySlug } from "@/content/blog/registry"
...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const title = edition?.meta.title ?? "Aminta Blog"
  const editionLabel = edition ? `EDITION ${String(edition.meta.edition).padStart(3, "0")}` : "AMINTA BLOG"
