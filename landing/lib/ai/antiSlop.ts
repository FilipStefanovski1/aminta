 ...
 * detectSlop flags a draft and/or lib/ai/claimFidelity.ts's semantic-
 * fidelity check finds a meaning-changing violation — never replaces an
 * existing templateInstruction (a News/Product preset, say), only adds to
 * it. Mirrors lib/ai/lengthGuard-equivalent conventions elsewhere in this
 * file's extension counterpart.
 *
