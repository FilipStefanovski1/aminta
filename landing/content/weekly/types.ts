// Weekly edition content types. Each edition is a small TypeScript module
// (see content/weekly/editions/) exporting a typed `meta` object matching
...
// keeps draft content out of production by default (see WeeklyEditionMeta.status).
...
export interface WeeklyEditionMeta {
   ...
   * "/weekly/edition-001/ai-writing-sameness.webp". Every published edition
   * must have one — rendered at HERO_IMAGE_WIDTH x HERO_IMAGE_HEIGHT
   * (see below), reused as-is for the /weekly card, the article hero, and
...
export interface WeeklyEditionModule {
  meta: WeeklyEditionMeta
  Content: ComponentType
}

// One canonical aspect ratio for every hero image (16:9), reused across the
// /weekly featured card, thumbnail previews, the article hero, and the OG
