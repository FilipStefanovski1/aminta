  ...
  return (
    <div className="rounded-xl overflow-hidden" style={{ backgroundColor: "#262628", border: "1px solid #404048" }}>
      <div className="px-4 py-4">
        <p className={T.sectionTitle} style={{ color: C.text }}>Learned data</p>

        {!open ? (
          <>
            <p className="text-[12px] leading-snug mt-2" style={{ color: C.textFaint }}>
            ...
            <button
              ...
              className="text-[11px] mt-3 disabled:opacity-40 disabled:cursor-not-allowed"
          ...
          <div className="mt-2 space-y-2.5">
            ...
            {error && <p className="text-[12px] leading-snug text-red-400">{error}</p>}
            <div className="flex gap-2 pt-0.5">
              <button
                onClick={() => { setOpen(false); setError("") }}
                disabled={busy}
                className="flex-1 rounded-lg py-2 text-[12px] font-medium disabled:opacity-40"
              ...
              <button
                onClick={run}
                disabled={busy}
                className="flex-1 rounded-lg py-2 text-[12px] font-semibold disabled:opacity-40 disabled:cursor-wait"
